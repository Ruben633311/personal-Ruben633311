...
esp_err_t I2CManager::readRegisterpcf(uint8_t* value) {
    return readRegister(0x20, 0x00, value, 1);
}

esp_err_t I2CManager::writeRegisterpcf(uint8_t value) {
    return writeRegister(0x20, 0x00, &value, 1);
}
